  ...
  return (
    <div className="min-h-screen grid-bg flex items-center justify-center p-6">
      <div className="w-full max-w-md card-surface p-8 relative">
        ...
        {google.enabled && (
          <>
            <button type="button" onClick={google.onClick} className="w-full border border-[#1E293B] bg-[#0B0E14] hover:border-emerald-500/50 py-2.5 font-mono text-sm text-slate-200 inline-flex items-center justify-center gap-2 mb-4" data-testid="google-signin">
